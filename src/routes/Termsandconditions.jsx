...
const TermsAndConditions = () => {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <Header />
      <main className="container mx-auto max-w-4xl bg-white p-8 shadow-lg rounded-md mt-10 mb-10">
        <h1 className="text-4xl font-bold text-gray-800 mb-6">Términos y Condiciones de Uso</h1>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">2. Uso del Servicio</h2>
          <p className="text-gray-600 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">3. Registro y Cuenta</h2>
          <p className="text-gray-600 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">4. Derechos de Propiedad Intelectual</h2>
          <p className="text-gray-600 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">5. Limitación de Responsabilidad</h2>
          <p className="text-gray-600 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">6. Modificaciones</h2>
          <p className="text-gray-600 mb-4">

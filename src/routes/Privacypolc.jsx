  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto max-w-4xl bg-white p-8 shadow-lg rounded-md mt-10 mb-10">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">4. Seguridad</h2>
          <p className="text-gray-600 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">5. Derechos del Usuario</h2>
          <p className="text-gray-600 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">6. Cambios en la Política de Privacidad</h2>
          <p className="text-gray-600 mb-4">

            ...
            >
              <div className="grid mr-4 place-items-center">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M7.5 6v.75H5.513c-.96 0-1.764.724-1.865 1.679l-1.263 12A1.875 1.875 0 004.25 22.5h15.5a1.875 1.875 0 001.865-2.071l-1.263-12a1.875 1.875 0 00-1.865-1.679H16.5V6a4.5 4.5 0 10-9 0zm1.5.75V6a3 3 0 116 0v.75h-6zM6.463 8.25H17.54l1.183 11.25H5.28L6.463 8.25z"
                    clipRule="evenodd"
                  ></path>
                </svg>
              </div>
              <p className="block mr-auto font-sans text-base antialiased font-normal leading-relaxed text-blue-gray-700">
                Orders
              </p>
              <span className="ml-4">
                <svg
